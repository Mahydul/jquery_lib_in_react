...
export var showSpin = ()=>{
    (function () {   
        function t(t, i, e) {
        (this.div = t),
        (this.src = i || t.dataset.src),
        (this.frameCount = e || t.dataset.frames || 36),
        (this.canvas = document.createElement("canvas")),
        t.appendChild(this.canvas),
        (this.arrows = document.createElement("div")),
        (this.arrows.className = "spin-360-arrows"),
        t.appendChild(this.arrows),
        (this.degrees = 0),
        (this.rotation = 0);
        var n = this;
        ...
        n.div.classList.remove("spin-360-deg"), (n.div.innerHTML = '<embed type="application/x-shockwave-flash" src="' + t + '" width="400" height="450" quality="high" wmode="opaque">'), (n.image = null);
        }),
        ...
        (this.div.onmousedown = function (t) {
        (n.lastPosition = { x: t.screenX, y: t.screenY }), (n.dragging = !0);
        }),
        (this.div.ontouchstart = function (t) {
        (n.lastPosition = { x: t.changedTouches[0].screenX, y: t.changedTouches[0].screenY }), (n.dragging = !0);
        }),
        ...
        a > 0.3 && a < 2.7 && (t.preventDefault(), t.stopPropagation()), (this.rotation = e), (this.lastPosition = { x: t.changedTouches[0].screenX, y: t.changedTouches[0].screenY });
        } else (this.rotation = this.lastPosition.x - t.screenX), (this.lastPosition = { x: t.screenX, y: t.screenY });
        this.rotateBy(this.rotation);
        }
        }),
        (t.prototype.stopDragging = function () {
        function t() {
        i.dragging || ((i.rotation *= 0.95), i.rotateBy(i.rotation), Math.abs(i.rotation) > 1 ? requestAnimationFrame(t) : (i.arrows.style.opacity = "0"));
        }
        this.dragging = !1;
        var i = this;
        t();
        ...
        (e = e || 36), (i = i.replace(".swf", ".jpg")), document.write('<div class="spin-360-deg"></div>'), new t(document.querySelector(".spin-360-deg"), i, e);
        });
        })();
}
